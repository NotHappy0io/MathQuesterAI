const BUILT_IN_KEY = import.meta.env.VITE_OPENROUTER_API_KEY || "";

const MODEL_IDS = {
  fast: "stepfun/step-3.5-flash:free",
  advanced: "openrouter/healer-alpha",
  pro: "openrouter/hunter-alpha",
};
...
export async function getGuestAIResponse(userMessage, chatHistory) {
...
export async function getAIResponse(
  ...
  const aiModel = MODEL_IDS[model] || MODEL_IDS.fast;
